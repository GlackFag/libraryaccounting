...
@Configuration
@ComponentScan("space.cybeel.libraryaccounting")
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("space.cybeel.libraryaccounting.repositories")
@EnableWebMvc
public class SpringContextConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("space.cybeel.libraryaccounting.models");
